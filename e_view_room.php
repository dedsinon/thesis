...
// FILTER BY ROOM 
            $( "#filter_room_id" ).change(function() {
                ...
                window.location.href = "e_view_room.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $room_course_strand; ?>&term_grading=<?php echo $room_term_grading; ?>&room_id="+room_id+"<?php echo $url_settings; ?>";
             ...
             $( "#filter_room_course_strand" ).change(function() {
                ...
                //alert(filterBy);
                window.location.href = "e_view_room.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand="+course_strand+"<?php echo $url_settings; ?>";
            ...
            $( "#filter_room_term_grading" ).change(function() {
                ...
                //alert(filterBy);
                window.location.href = "e_view_room.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $course_strand; ?>&term_grading="+term_grading+"<?php echo $url_settings; ?>";
        ...
        <select class="form-control" id="filter_room_term_grading" name="filter_room_term_grading">
          <option value="">Select</option>
            ...
            <?php }elseif($room_course_strand == 'Strand'){ ?>  
              ...
              <option value="1st Grading" <?php echo $room_term_grading == '1st Grading' ? 'selected':''; ?>>1st Grading</option>
              <option value="2nd Grading" <?php echo $room_term_grading == '2nd Grading' ? 'selected':''; ?>>2nd Grading</option>
            ...
            $room_query = mysqli_query($conn, $room_retrieve);
              ...
              if($room_query){
                ...
                while ($room_result = mysqli_fetch_assoc($room_query)){
                  ...
                  echo '<option value="'.$room_result['room_id'].'" '.$is_selected.'>'.'[ '.$room_result['room_number'].' ] '.$room_result['room_name'].' </option>';
                }
              }
          ?>
        </select>
...
<div class="panel panel-default">
    ...
    <div class="modal fade" id="myModalSettings" role="dialog">
        ...
        <!-- Modal content-->
        <form id="frm_update_settings" method="POST" action="e_view_room.php">
