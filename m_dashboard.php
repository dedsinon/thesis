...
<div id="wrapper">
        ...
        <li class="dropdown">
            <a href="#Username" class="dropdown-toggle" data-toggle="dropdown"><i class="glyphicon glyphicon-user"></i> <?php echo $_SESSION['user_name'];?> <b class="caret"></b></a>
                <ul class="dropdown-menu">
                    <li>
                        <a href="m_user_profile.php"><i class="fa fa-fw fa-user"></i> User Profile</a>
                    </li>
                    <li class="divider">  
                    </li>
                    <li>
        ...
        <div class="nav-side-menu collapse navbar-collapse navbar-ex1-collapse" id="accordion">
            ...
            <ul class="nav navbar-nav side-nav">
                ...
                <!-- Manage Schedule -->
                <li>
                    <a href="m_view_reports_class.php" data-toggle="collapse" data-parent="accordion" data-target="#3"><i class="fa fa-fw fa-bar-chart"></i> View and Print Reports </a>
                    </li>
                <!-- End Manage Schedule -->
                ...
                <li>
                    ...
                    <ul id="3" class="collapse">
                         <li>
                            <a href="m_monitor_schedule.php">Schedule Monitoring</a>
                        </li>
                        <li>
                            <a href="m_monitor_view.php">View Monitoring</a>
                        </li>
