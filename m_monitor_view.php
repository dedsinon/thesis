...
<body>
  ...
  <div class="row">
    <div class="col-lg-">
      ...
      <ul class="breadcrumb">
          <li>You are here:</li>
          <li class="active" title="View Room"> <a href="m_monitor_view.php">View Monitor Schedule</a></li>
      </ul>
   ...
   <!-- View Class -->
          ...
          <div class="panel panel-default">
            <div class="panel-heading" id="head1"> <b>View Monitor Schedule  </b>
             ...
             <form method="POST" action="m_monitor_p_view.php" target="_top" id="myform">
