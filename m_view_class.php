            ...
            if($section_id){
                ...
                while ($schedule_result = mysqli_fetch_assoc($get_schedule_query)){
                    ...
                    $events[] = array(
                        ...
                        'end'               => $new_end_time,
                        'id'           => ' Room: ['. $schedule_result['room_number'].']',
...
// FILTER BY Section 
    $( "#filter_section_id" ).change(function() {
      ...
      //alert(filterBy);
      window.location.href = "m_view_class.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $course_strand; ?>&term_grading=<?php echo $term_grading; ?>&section_id="+section_id+"<?php echo $url_settings; ?>";
    });
            
    $( "#filter_course_strand" ).change(function() {
      var course_strand = $(this).val();
      //alert(filterBy);
      window.location.href = "m_view_class.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand="+course_strand+"<?php echo $url_settings; ?>";
    });
            
    $( "#filter_term_grading" ).change(function() {
      var term_grading = $(this).val();
      //alert(filterBy);
      window.location.href = "m_view_class.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $course_strand; ?>&term_grading="+term_grading+"<?php echo $url_settings; ?>";
      });
              ...
              $sec_query = mysqli_query($conn, $sec_retrieve);
                ...
                if($sec_query){
                  ...
                  while ($sec_result = mysqli_fetch_assoc($sec_query)){
                    ...
                    echo '<option value="'.$sec_result['sec_id'].'" '.$is_selected.'>'.'[ '.$sec_result['sec_code'].' ] '.$sec_result['sec_name'].' </option>';
                  }
                }
            ?>
        </select>
...
<div class="panel panel-default">
    ...
    <div class="modal fade" id="myModalSettings" role="dialog">
        ...
        <!-- Modal content-->
        <form id="frm_update_settings" method="POST" action="m_view_class.php">
