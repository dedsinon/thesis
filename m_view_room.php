...
// FILTER BY ROOM 
            $( "#filter_room_id" ).change(function() {
                ...
                window.location.href = "m_view_room.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $room_course_strand; ?>&term_grading=<?php echo $room_term_grading; ?>&room_id="+room_id+"<?php echo $url_settings; ?>";
             ...
             $( "#filter_room_course_strand" ).change(function() {
                ...
                //alert(filterBy);
                window.location.href = "m_view_room.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand="+course_strand+"<?php echo $url_settings; ?>";
            ...
            $( "#filter_room_term_grading" ).change(function() {
                ...
                //alert(filterBy);
                window.location.href = "m_view_room.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $course_strand; ?>&term_grading="+term_grading+"<?php echo $url_settings; ?>";
...
<div class="panel panel-default">
    ...
    <div class="modal fade" id="myModalSettings" role="dialog">
        ...
        <!-- Modal content-->
        <form id="frm_update_settings" method="POST" action="m_view_room.php">
