...
// FILTER BY Teacher 
            $( "#filter_teacher_id" ).change(function() {
                ...
                window.location.href = "m_view_teacher_calendar.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $teacher_course_strand; ?>&term_grading=<?php echo $teacher_term_grading; ?>&teacher_id="+teacher_id+"<?php echo $url_settings; ?>";
             ...
             $( "#filter_teacher_course_strand" ).change(function() {
                ...
                //alert(filterBy);
                window.location.href = "m_view_teacher_calendar.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand="+course_strand+"<?php echo $url_settings; ?>";
            ...
            $( "#filter_teacher_term_grading" ).change(function() {
                ...
                //alert(filterBy);
                window.location.href = "m_view_teacher_calendar.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $course_strand; ?>&term_grading="+term_grading+"<?php echo $url_settings; ?>";
...
<div class="container-fluid">
  <ul class="nav nav-tabs">
    <li class="active"><a href="m_view_teacher_calendar.php" > Teacher Calendar View:</a></li>
    <li><a href="m_view_teacher_list.php" > Teacher List View</a></li>                  
  </ul>
</div>
<br />
...
<div class="panel panel-default">
    ...
    <div class="modal fade" id="myModalSettings" role="dialog">
        ...
        <!-- Modal content-->
        <form id="frm_update_settings" method="POST" action="m_view_teacher_calendar.php">
