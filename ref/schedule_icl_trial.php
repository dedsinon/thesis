...
<head>
    ...
    $settings_term_grading = mysqli_escape_string($conn, isset($_REQUEST['settings_term_grading']) ? $_REQUEST['settings_term_grading']: 'Term 1');
    ...
    $settings = array(
      ...
      'settings_term_grading' => $settings_term_grading,
    ...
    $filter_school_year = isset($_GET['school_year']) ? $_GET['school_year'] : $settings_school_year;
        ...
        if($filter_by){
            ...
            if($section_id){
                ...
                $where_sql = "sc.teacher_id_fk = '$teacher_id'";
            }else if($room_id){
                $where_sql = "sc.room_id_fk = '$room_id'";
            }
      ...
      if($status != ''){
        $where_settings_sql = " AND sc.is_approved = '$status'";
            ...
            if($section_id || $teacher_id ||$room_id){
                $get_schedule_sql ="SELECT * FROM schedule as sc LEFT JOIN subject as su ON sc.subject_id_fk = su.subj_id LEFT JOIN rooms AS ro ON sc.room_id_fk = ro.room_id LEFT JOIN section AS sec ON sc.section_id_fk = sec.sec_id WHERE $where_sql $where_settings_sql AND sc.school_year = '".$filter_school_year."' AND sc.term_grading = '".$settings_term_grading."' ";
                ...
                while ($schedule_result = mysqli_fetch_assoc($get_schedule_query)){
                    ...
                    $events[] = array(
                        ...
                        'textColor'    => $schedule_result['text_color'],
                    );
                }
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $( "#filter_by" ).change(function() {
                ...
                //alert(filterBy);
                window.location.href = "schedule_icl_trial.php?filterBy=" + filterBy +"&school_year=<?php echo $filter_school_year; ?><?php echo $url_settings; ?>";
            ...
            $( "#filter_section_id" ).change(function() {
                ...
                //alert(filterBy);
                window.location.href = "schedule_icl_trial.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $course_strand; ?>&term_grading=<?php echo $term_grading; ?>&section_id="+section_id+"<?php echo $url_settings; ?>";
      ...
      $( "#filter_course_strand" ).change(function() {
                ...
                //alert(filterBy);
                window.location.href = "schedule_icl_trial.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand="+course_strand+"<?php echo $url_settings; ?>";
      ...
      $( "#filter_term_grading" ).change(function() {
                ...
                //alert(filterBy);
                window.location.href = "schedule_icl_trial.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $course_strand; ?>&term_grading="+term_grading+"<?php echo $url_settings; ?>";

            });

            $( "#filter_teacher_id" ).change(function() {
                var teacher_id = $(this).val();
                window.location.href = "schedule_icl_trial.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&teacher_id="+teacher_id+"<?php echo $url_settings; ?>";

            });

            $( "#filter_room_id" ).change(function() {
                var room_id = $(this).val();
                window.location.href = "schedule_icl_trial.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&term_grading=<?php echo $settings_term_grading; ?>&room_id="+room_id+"<?php echo $url_settings; ?>";
        ...
        $.ajax({
          ...
          success: function(data){
            ...
            if(data.class == 'success'){
              $('#add_sc_id option').remove();
              $('#add_sc_id').append('<option value="">Select</option>');
            ...
            $('#add_term_grading').append('<option value="">Select</option>');
...
<body>
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <div class="col-xs-3">
                <h4>Filter Schedule (<?php echo $filter_school_year; ?>) (<?php echo $settings_term_grading; ?>)</h4>
            ...
            <select class="form-control" id="filter_course_strand" name="filter_course_strand">
                ...
                <option value="Strand" <?php echo $course_strand == 'Strand' ? 'selected':''; ?>>High School</option>                     
                          </select>
            ...
            <select class="form-control" id="filter_term_grading" name="filter_term_grading">
               ...
               <?php }elseif($course_strand == 'Strand'){ ?>  
                <option value="1st Grading" <?php echo $term_grading == '1st Grading' ? 'selected':''; ?>>1st Grading</option>
                <option value="2nd Grading" <?php echo $term_grading == '2nd Grading' ? 'selected':''; ?>>2nd Grading</option>
   ...
   <!-- Modal Settings -->
    <div class="modal fade" id="myModalSettings" role="dialog">
        ...
        <!-- Modal content-->
        <form id="frm_update_settings" method="POST" action="schedule_icl_trial.php">
                    ...
                    <?php 
                     ...
                     <div class="form-group col-lg-6">
                        ...
                        <div class="input-group">
                          ...
                          <select class="form-control" name="settings_term_grading">
                            <option <?php echo ($settings_term_grading == '1st Term') ? 'selected':''; ?>  value="1st Term">1st Term</option>
                            <option <?php echo ($settings_term_grading == '2nd Term') ? 'selected':''; ?> value="2nd Term">2nd Term</option>
                            <option <?php echo ($settings_term_grading == '3rd Term') ? 'selected':''; ?> value="3rd Term">3rd Term</option>
                            <option <?php echo ($settings_term_grading == '1st Grading') ? 'selected':''; ?> value="1st Grading">1st Quarter</option>
                            <option <?php echo ($settings_term_grading == '2nd Grading') ? 'selected':''; ?> value="2nd Grading">2nd Quarter</option>
                            <option <?php echo ($settings_term_grading == '1st Grading') ? 'selected':''; ?> VALUE="1st Grading" value="1st Term">1st Quarter - 1st Term</option>                             
                          </select>
                        </div>
                    </div>
                    s
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group">
                          ...
                          <select class="form-control" name="settings_day_start">
                              <option value="1" <?php echo ($settings_day_start == 1) ? 'selected':''; ?>>
                              Monday</option>
