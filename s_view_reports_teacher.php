...
<body>
  ...
  <div class="row">
    <div class="col-lg-">
      ...
      <ul class="breadcrumb">
          <li>You are here:</li>
          <li class="active" title="View Room"> <a href="s_view_reports_teacher.php">View Reports</a></li>
      </ul>
            ...
            <br />
              <div class="container-fluid">
                <ul class="nav nav-tabs">
                  ...
                  <li><a href="s_view_reports_room.php" > View Room Schedule</a></li>
                  <li class="active"><a href="s_view_reports_teacher.php" > View Teacher Schedule</a></li>
        ...
        <!-- View Teacher Faculty Loading -->
          ...
          <div class="panel panel-default">
            <div class="panel-heading" id="head1"> <b>View Teacher's Faculty Loading Schedule </b>
             ...
             <form method="POST" action="s_view_p_teacher_schedule_list.php" target="_blank" id="myform">
