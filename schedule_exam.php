...
<body>
  ...
  <div class="row">
    <div class="col-lg-">
      ...
      <ul class="breadcrumb">
          <li>You are here:</li>
          <li class="active" title="View Room"> <a href="schedule_exam.php">Examination Schedule</a></li>
      </ul>
            ...
            <div class="col-lg-12">
              ...
              <div class="container-fluid">
                <ul class="nav nav-tabs">
                  <li  class="active"><a href="schedule_exam.php" > College Exam Schedule:</a></li>
                  <li><a href="schedule_exam_shs.php" > Senior Highschool Exam Schedule</a></li>
  ...
  <div class="panel panel-default">
    ...
    $sy_query = mysqli_query($conn, $sy);
        ...
        while ($sy_result = mysqli_fetch_assoc($sy_query)){
         ...
         $sql  = "SELECT * FROM exam as ex LEFT JOIN schedule as sc ON ex.exam_schedule_id_fk = sc.schedule_id LEFT JOIN day ON ex.exam_day = day.day_id LEFT JOIN rooms as ro ON ex.exam_room = ro.room_id LEFT JOIN teacher as te ON ex.exam_teacher = te.teacher_id LEFT JOIN section as sec ON sc.section_id_fk = sec.sec_id LEFT JOIN subject as subj ON sc.subject_id_fk = subj.subj_id WHERE school_year = '$schoolyear' AND exam_term IN ('1st Term', '2nd Term', '3rd Term') ";
    ...
    <tr>
                    ...
                    <div class="modal-body">
                      <form method="POST" action="#">
                        ...
                        <div hidden> <input type="number" name="update_room_id" class="form-control" value="<?php echo $result['exam_id']; ?>" readonly>
                        </div>
                  ...
                  <label>[ 1 ] Term </label>
                        <div class="input-group">
                          ...
                          <select class="form-control" name="e_term_grading" onchange="getTerm(this.value);" required>
                            <option value="<?php echo $result['exam_term']; ?>"><?php echo $result['exam_term']; ?></option>
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <div class="input-group">
                          ...
                          <select class="form-control" name="e_subject" required id="subject1">
                            <option value="<?php echo $result['exam_subject_id_fk']; ?>"><?php echo $result['subj_name']; ?></option>
                    ...
                    <?php 
                        ...
                        $query = mysqli_query($conn, $retrieve);
                          ...
                          ?>
                          <select class="form-control" name="e_day" required>
                            <option value="<?php echo $result['exam_day']; ?>"> <?php echo $result['day_name']; ?></option>
                     ...
                     <div class="form-group col-lg-6">
                        ...
                        $room_query = mysqli_query($conn, $room_retrieve);
                          ...
                          <select class="form-control" name="e_teacher" required>
                            ...
                            <?php
                            while ($result = mysqli_fetch_assoc($room_query)){
                                ?>
                    ...
                    <td style="text-align: center;">
                     <!-- Delete Button -->
                    <button type="button" class="btn btn-danger btn-xs" data-toggle="modal" data-target="#delete<?php echo $result['exam_id']; ?>">
                      <span class="glyphicon glyphicon-trash"></span> Delete </button>

                    <!-- Delete Modal -->
                    <div id="delete<?php echo $result['exam_id']; ?>" class="modal fade" role="dialog">
                    <div class="modal-dialog">
                    ...
                    <!-- Delete Modal Body -->
                    <div class="modal-body">
                        <p>Are you sure do you want to delete the exam schedule?</p>

                        <div class="btn-group" role="group">
                             <button type="button" class="btn btn-primary btn-md" id="<?php echo $result['exam_id']; ?>" onclick="window.location.href='server/p_delete_icl.php?userid=<?php echo $result['exam_id']; ?>'"><span class="glyphicon glyphicon-thumbs-up"></span> Delete</button>
                            </form>
                        </div>
                        
                        <div class="btn-group" role="group">
                            <button type="button" class="btn btn-primary btn-md btn-icon icon-left delete_btn" data-dismiss="modal"  role="button"><i class="fa fa-times" aria-hidden="false"> Close</i>
                            </button>
                        </div>
                    </div>
