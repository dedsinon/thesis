...
// FILTER BY Section 
    $( "#filter_section_id" ).change(function() {
      ...
      //alert(filterBy);
      window.location.href = "view_class.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $course_strand; ?>&term_grading=<?php echo $term_grading; ?>&section_id="+section_id+"<?php echo $url_settings; ?>";
    });
            
    $( "#filter_course_strand" ).change(function() {
      var course_strand = $(this).val();
      //alert(filterBy);
      window.location.href = "view_class.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand="+course_strand+"<?php echo $url_settings; ?>";
    });
            
    $( "#filter_term_grading" ).change(function() {
      var term_grading = $(this).val();
      //alert(filterBy);
      window.location.href = "view_class.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $course_strand; ?>&term_grading="+term_grading+"<?php echo $url_settings; ?>";
      });
...
<div class="panel panel-default">
    ...
    <div class="modal fade" id="myModalSettings" role="dialog">
        ...
        <!-- Modal content-->
        <form id="frm_update_settings" method="POST" action="view_class.php">
