...
<head>
    ...
    <?php
        ...
        $events = array();
                $get_schedule_sql ="SELECT * FROM schedule as sc LEFT JOIN subject as su ON sc.subject_id_fk = su.subj_id  LEFT JOIN teacher as te ON sc.teacher_id_fk = te.teacher_id LEFT JOIN rooms AS ro ON sc.room_id_fk = ro.room_id LEFT JOIN section AS sec ON sc.section_id_fk = sec.sec_id WHERE sc.section_id_fk = '$sec_id'  AND school_year = '$year' AND term_grading IN ('$term','$quarter')";
                ...
                while ($schedule_result = mysqli_fetch_assoc($get_schedule_query)){
                    ...
                    $events[] = array(
                        ...
                        'title'             => $schedule_result['subj_name'] .' ['.$schedule_result['subj_code'].']',
...
<div class="panel panel-default">
    <div class="panel-body">
        <div class="col-xs-5">
            ...
            <label> <?php echo $section <> '' ? $section : 'No Records' ; ?></label>
        </div>
        ...
        <div class="col-xs-3">
           <label>Term/Quarter: </label>
            <label>Term/Quarter: <?php if($term == ''){
                            echo $quarter;
                            }else if($quarter ==''){
                                echo $term;
