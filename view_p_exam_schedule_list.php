...
//Monday
           $schedule_sql ="SELECT * FROM exam as ex LEFT JOIN schedule as sched ON ex.exam_schedule_id_fk = sched.schedule_id WHERE sc.teacher_id_fk = '$teach_id'  AND school_year = '$year' AND term_grading IN ('$term','$quarter') AND day='1' ORDER BY start_time, end_time ASC";
