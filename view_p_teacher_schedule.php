...
<head>
    ...
    <?php
        ...
        $events = array();
                $get_schedule_sql ="SELECT * FROM schedule as sc LEFT JOIN subject as su ON sc.subject_id_fk = su.subj_id LEFT JOIN rooms AS ro ON sc.room_id_fk = ro.room_id LEFT JOIN teacher as te ON sc.teacher_id_fk = te.teacher_id LEFT JOIN section AS sec ON sc.section_id_fk = sec.sec_id WHERE sc.teacher_id_fk = '$teach_id'  AND school_year = '$year' AND term_grading IN ('$term','$quarter')";
