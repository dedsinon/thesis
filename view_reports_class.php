...
<body>
  ...
  <div class="row">
    <div class="col-lg-">
      ...
      <ul class="breadcrumb">
          <li>You are here:</li>
          <li class="active" title="View Room"> <a href="view_reports_class.php">View Reports</a></li>
      </ul>
   ...
   <!-- View Class -->
          ...
          <div class="panel panel-default">
            <div class="panel-heading" id="head1"> <b>View Class Schedule  </b>
             ...
             <form method="POST" action="view_p_class_schedule.php" target="_blank" id="myform">
            ...
            <br />
              <div class="container-fluid">
                <ul class="nav nav-tabs">
                  <li  class="active"><a href="view_reports_class.php" > View Class Schedule:</a></li>
