        ...
        <!-- View Exam Loading -->
          ...
          <div class="panel panel-default">
            <div class="panel-heading" id="head1"> <b>View Teacher's Faculty Loading Schedule </b>
             ...
             <form method="POST" action="view_p_exam_schedule_list.php" target="_blank" id="myform">
             ...
             <br />
              <div class="container-fluid">
                <ul class="nav nav-tabs">
                  ...
                  <li><a href="view_reports_teacher.php" > View Teacher Schedule</a></li>
                  <li class="active"><a href="view_reports_exam.php" > View Exam Schedule</a></li>                  
                </ul>
              </div>
            <br />
              ...
              <div class="form-group col-lg-6">
                <label>[ 1 ] Teacher</label>
                  <div class="input-group">
                    ...
                    <?php 
                        $teach_retrieve ="SELECT * FROM subject";
                        $teach_query = mysqli_query($conn, $teach_retrieve);
                          
                          if($teach_query){
                          ?>
                          <select class="form-control" name="subj_id" required>
                            ...
                            <option value="<?php echo $teach_result['subj_id']; ?>"> <?php echo $teach_result['subj_name']; ?> </option>
