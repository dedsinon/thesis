...
<body>
  ...
  <div class="row">
    <div class="col-lg-">
      ...
      <ul class="breadcrumb">
          <li>You are here:</li>
          <li class="active" title="View Room"> <a href="view_reports_room.php">View Reports</a></li>
      </ul>
   ...
   <!-- View Class -->
          ...
          <div class="panel panel-default">
            <div class="panel-heading" id="head1"> <b>View Room Schedule  </b>
             ...
             <form method="POST" action="view_p_room_schedule.php" target="_blank" id="myform">
            ...
            <br />
              <div class="container-fluid">
                <ul class="nav nav-tabs">
                  ...
                  <li  class="active"><a href="view_reports_room.php" > View Room Schedule</a></li>
