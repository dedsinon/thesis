...
<body>
  ...
  <div class="row">
    <div class="col-lg-">
      ...
      <ul class="breadcrumb">
          <li>You are here:</li>
          <li class="active" title="View Room"> <a href="view_reports_teacher.php">View Reports</a></li>
      </ul>
    

   <!-- View Calendar Teacher -->
          <div class="container-fluid">
          <div class="row">         
          <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading" id="head1"> <b>View Teacher's Calendar Schedule  </b>
             ...
             <form method="POST" action="view_p_teacher_schedule.php" target="_blank" id="myform">
            ...
            <br />
              <div class="container-fluid">
                <ul class="nav nav-tabs">
                  <li><a href="view_reports_class.php" > View Class Schedule:</a></li>
                  <li><a href="view_reports_room.php" > View Room Schedule</a></li>
                  <li class="active"><a href="view_reports_teacher.php" > View Teacher Schedule</a></li>
                  <li><a href="view_reports_exam.php" > View Exam Schedule</a></li>                  
                </ul>
              </div>
            <br />
                    ...
                    <?php 
                        ...
                        $teach_query = mysqli_query($conn, $teach_retrieve);
                          ...
                          <select class="form-control" name="teach_id" required>
                            ...
                            <option value="<?php echo $teach_result['teacher_id']; ?>"> <?php echo $teach_result['teacher_fullname']; ?> </option>
      ...
      <div class="panel-footer">
                    <button type="submit" name="submit" class="btn btn-primary" value='submit' id="submit"><i class="fa fa-calendar"></i> View Teacher Schedule</button>
        ...
        <!-- View Teacher Faculty Loading -->
          <div class="container-fluid">
          <div class="row">         
          <div class="col-lg-12">
          <div class="panel panel-default">
            <div class="panel-heading" id="head1"> <b>View Teacher's Faculty Loading Schedule </b>
             
            </div>

             <form method="POST" action="view_p_teacher_schedule_list.php" target="_blank" id="myform">
      ...
      <div class="panel-footer">
                    <button type="submit" name="submit" class="btn btn-primary" value='submit' id="submit"><i class="fa fa-list"></i> View Teacher Schedule</button>
