...
// FILTER BY Teacher 
            ...
            $( "#filter_teacher" ).change(function() {
                ...
                window.location.href = "view_teacher_list.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $teacher_course_strand; ?>&term_grading=<?php echo $teacher_term_grading; ?>&teacher_id="+teacher_id+"<?php echo $url_settings; ?>";
            ...
            $( "#filter_teacher_id" ).change(function() {
             ...
             $( "#filter_teacher_course_strand" ).change(function() {
                ...
                //alert(filterBy);
                window.location.href = "view_teacher_list.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand="+course_strand+"<?php echo $url_settings; ?>";
            ...
            $( "#filter_teacher_term_grading" ).change(function() {
                ...
                //alert(filterBy);
                window.location.href = "view_teacher_list.php?filterBy=<?php echo $filter_by; ?>&school_year=<?php echo $filter_school_year; ?>&course_strand=<?php echo $course_strand; ?>&term_grading="+term_grading+"<?php echo $url_settings; ?>";
...
<div class="container-fluid">
  <ul class="nav nav-tabs">
    <li><a href="view_teacher_calendar.php" > Teacher Calendar View:</a></li>
    <li class="active"><a href="view_teacher_list.php" > Teacher List View</a></li>                  
  </ul>
</div>
<br />
<!-- PAGE CONTENT BEGINS 
  <div class="row">
    ...
    <div class="col-xs-4">   
      <label>Teacher</label>
        <select class="form-control" id="filter_teacher_id" name="filter_teacher_id">
          <option value=""> Select</option>
              ...
              $teach_query = mysqli_query($conn, $teach_retrieve);
                ...
                if($teach_query){
                  while ($teach_result = mysqli_fetch_assoc($teach_query)){
                   $teacher_id == $teach_result['teacher_id'] ? 'selected':''; 
    ...
    <?php } ?>
    <br />  <!-- PAGE CONTENT BEGINS -->         
    
<div class="col-xs-12">   
      <label>Teacher</label>
        <select class="form-control" onchange="getId(this.value);" required>
          <option value=""> Select</option>
...
<div class="panel panel-default">
    <div class="panel-body">
        ...
        <div class="col-xs-3">
            <label> Recommending for Approval:</label><br /><br />
        ...
        <div class="col-xs-3">
            ...
            <input type="text" value="Ms. Yolanda Soliveres" style="border: none;" disabled /><br />
            <label>&nbsp;&nbsp;CH/Vice President &nbsp;&nbsp;</label>
        </div>
    </div>
</div>
</div>
    ...
    <div class="modal fade" id="myModalSettings" role="dialog">
        ...
        <!-- Modal content-->
        <form id="frm_update_settings" method="POST" action="view_teacher_list.php">
